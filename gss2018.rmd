...
$H_A$ there is no relationship between gun ownership and opinion on the death penalty 

$H_A$ there is relationship between gun ownership and opinion about the death penalty
...
both variables are categorical, so we use the Cat~cat helper file
